...
public class AppUITest {
    ...
    public void homeScreenActivityTest() {
        ...
        ViewInteraction textView1 = onView(
                allOf(withId(R.id.story_count), withText("0."),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView1.check(matches(withText("0.")));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.story_title), withText("Snap’s drop in active users could signal a social media peak"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView2.check(matches(withText("Snap’s drop in active users could signal a social media peak")));

        ViewInteraction textView3 = onView(
                allOf(withId(R.id.story_points), withText("124 time:1533689229"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class),
                                        1),
                                0),
                        isDisplayed()));
        textView3.check(matches(withText("124 time:1533689229")));

        ViewInteraction textView4 = onView(
                allOf(withId(R.id.story_comments), withText("|85 comments"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class),
                                        1),
                                1),
                        isDisplayed()));
        textView4.check(matches(withText("|85 comments")));
